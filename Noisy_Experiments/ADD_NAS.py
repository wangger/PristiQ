...
from ADD_basic_model_train import get_cir_len, get_num_parameters
...
if __name__ == "__main__":
    ...
    print("The circuit length is", cir_len)
    ...
    # if Is_ideal_acc:
    #     output_dir = "Added_Output/Baseline/Ideal/"
    # elif Is_real_qc:
    #     output_dir = "Added_Output/Baseline/Real_qc/"
    # else:
    #     output_dir = "Added_Output/Baseline/Noisy_sim/"
    ...
    # TODO(NOTE): New added
    output_dict["n_para"] = [n_paras]
    output_dict["cir_len"] = [cir_len]
