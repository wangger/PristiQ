...
class VQC_Net(tq.QuantumModule):
    ...
    def __init__(self, layer_list, args):
        super().__init__()
        self.n_ori_qubits = args.num_ori_qubits  # TODO: Added
        self.Not_Expanded = args.Not_Expanded   # TODO: Added
        ...
        for name in layer_list:
            ...
            if layer is not None:   # at least has one layer
                self.q_layers.append(layer(self.n_qubits, self.Not_Expanded, self.n_ori_qubits))  # TODO: Modified
    ...
    def forward(self, x, use_qiskit=False):
        ...
        for layer in self.q_layers:
            # print("I am here, the layer is", layer)
            layer(self.q_device)
            # states = self.q_device.states
