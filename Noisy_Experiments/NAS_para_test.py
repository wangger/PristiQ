...
def parse_args():
    ...
    # Data related
    parser.add_argument('--dataset', default='mnist', choices=['mnist', 'custom_xor', 'fmnist'],
    ...
    parser.add_argument('-dp', '--datapath', default='pytorch/data/', help='root path of the dataset of mnist/fmnist')
    ...
    parser.add_argument('--num_shots', default=8192, type=int, help='Number of shots for IBMQ execution/Noisy simulator')
...
if __name__ == "__main__":
    ...
    print(args_dict)
    dict_df = DataFrame(args_dict)
    print(dict_df)
    filename = 'test_df.csv'
    dict_df.to_csv(filename)
    ...
    # TODO(NOTE): To write the highlighted information
    highlight_dict = {}
    ...
    filename = 'test_df.csv'
    highlight_dict_df.to_csv(filename)
