...
class QuantumDevice(nn.Module):
    ...
    # TODO(NOTE): Added by me
    def set_states_me(self, states: torch.Tensor):   # the states should be in the shape (BS, 2, 2, ...)
        # self.states = states.to(C_DTYPE)
        self.states = states.clone().to(C_DTYPE)
